...
API_PATH = 'https://www.gamespot.com/api'
...
def CATEGORIES():
    ...
    if user_api_key:
        response = urllib2.urlopen(API_PATH + '/video_types/?api_key='
    ...
    name = 'Latest'
    url = (API_PATH + '/videos/?api_key='
           + API_KEY + '&sort=-publish_date&format=json')
    iconimage = ''
    addDir(name, url, 2, '')
